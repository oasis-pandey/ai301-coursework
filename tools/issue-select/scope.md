...
I am a junior Computer Science student with experience in Python, Java, JavaScript/TypeScript, Git, and web development. I am comfortable working with existing code and want to improve my debugging, testing, and open-source contribution skills. For my first issue, I prefer something with a clear and manageable scope that I can complete within the course timeline.
